...
- (void)testBase64LongWithCRLF
{
    ...
    XCTAssertEqualObjects(theBase64String1, theExpectedBase64String, @"Base64 encoding didn't match");
}
...
- (void)testBase64Data1
{
    ...
    XCTAssertEqualObjects(theBase64Data, theExpectedBase64Data, @"Base64 encoding didn't match");
}
